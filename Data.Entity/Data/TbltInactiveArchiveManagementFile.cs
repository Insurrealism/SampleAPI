...
{
    public partial class TbltInactiveArchiveManagementFile
    {
        public TbltInactiveArchiveManagementFile()
        {
            TbltAlihMediaDummyFileSelections = new HashSet<TbltAlihMediaDummyFileSelection>();
        ...
        public bool? IsSubmitAlihMedia { get; set; }
        ...
        public virtual ICollection<TbltAlihMediaDummyFileSelection> TbltAlihMediaDummyFileSelections { get; set; }
