...
{
    public partial class TbltActiveDocumentHistory
    {
        ...
        public Guid? ActiveDocumentStatusFileId { get; set; }
        ...
        public virtual TblmActiveDocumentStatusFile? ActiveDocumentStatusFile { get; set; }
    }
}
