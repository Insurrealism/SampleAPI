...
{
    public partial class TblmActiveDocumentStatusFile
    {
        public TblmActiveDocumentStatusFile()
        {
            TbltActiveDocumentHeaderSenders = new HashSet<TbltActiveDocumentHeaderSender>();
        ...
        public bool? IsCaculateRetensiAktif { get; set; }

        public virtual ICollection<TbltActiveDocumentHeaderSender> TbltActiveDocumentHeaderSenders { get; set; }
